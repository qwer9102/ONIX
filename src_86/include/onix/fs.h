...
#define BLOCK_BITS  (BLOCK_SIZE * 8)                          //磁盘中 bit数/block
#define BLOCK_INODES (BLOCK_SIZE / sizeof(inode_desc_t))      // 磁盘中inodes数/block
#define BLOCK_DENTRIES (BLOCK_SIZE / sizeof(dentry_t))        // 磁盘中dentry目录数/block
#define BLOCK_INDEXES (BLOCK_SIZE / sizeof(u16))              // 磁盘中索引数/block
...
idx_t bmap(inode_t *inode,idx_t bblock,bool create);
