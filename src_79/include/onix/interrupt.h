...
#define IRQ_MASTER_NR 0x20  // 主片起始向量号,前面32个是Intel占用
...
//IF位相关
bool interrupt_disable();                //清除IF位,并返回之前的值
bool get_interrupt_state();              //获得IF位值
void set_interrupt_state(bool state);    //设置IF位值
